...
public class MockTestUtil {
    ...
    public MockTestResultEntity saveMockTestResultEntity(
        ...
        mockTestTotalCountResponse.setTotalScoreParts(
                mockTestTotalCountResponse.getTotalScoreParts() + PartHelper.totalScoreOfPart(partEntity, topicEntity)
        );

        mockTestTotalCountResponse.setTotalQuestionChildOfParts(
                mockTestTotalCountResponse.getTotalQuestionChildOfParts() + QuestionHelper.totalQuestionChildOfParents(partEntity.getQuestions(), topicEntity)
        );
    ...
    public void addMockTestDetailEntity(
        ...
        if (mockTestQuestionChildrenRequest instanceof MockTestSingleChoiceRequest mockTestSingleChoiceRequest) {
            ...
            if (isCorrectAnswer) {
                ...
                MockTestHelper.taskForCorrectAnswerOfMockTest(
                ...
                MockTestHelper.taskForIncorrectAnswerOfMockTest(
                        mockTestDetailEntity,
                        mockTestTotalCountResponse
                );
            }
